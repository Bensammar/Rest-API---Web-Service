...
public class HelloServiceLocator extends org.apache.axis.client.Service implements axisTest.HelloService {
    ...
    private java.lang.String hello_address = "http://localhost:8080/axisTest/services/hello";
    ...
    public axisTest.Hello gethello(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            axisTest.HelloSoapBindingStub _stub = new axisTest.HelloSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (axisTest.Hello.class.isAssignableFrom(serviceEndpointInterface)) {
                axisTest.HelloSoapBindingStub _stub = new axisTest.HelloSoapBindingStub(new java.net.URL(hello_address), this);
                _stub.setPortName(gethelloWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://axisTest", "helloService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://axisTest", "hello"));
        }
